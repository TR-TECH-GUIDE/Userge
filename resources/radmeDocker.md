...
- Setup configs
    - Download the sample config file <br>
        ...
        - ```wget https://raw.githubusercontent.com/TR-TECH-GUIDE/Userge/alpha/config.env.sample -O config.env```
        - ```vim config.env```
    - Download the yml file for docker-compose
        - ```wget https://raw.githubusercontent.com/TR-TECH-GUIDE/Userge/alpha/resources/docker-compose.yml```
